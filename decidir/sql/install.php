<?php
	...
	$create_tables = array('CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'decidir_fees'.'`(
								    `id_total` INT(11) NOT NULL AUTO_INCREMENT,
								    `id_cart` INT(11) NOT NULL,
								    `total` DECIMAL(5,2),
								    `shipping_cost` DECIMAL(5,2),
								    `financial_cost` DECIMAL(5,2),
								    PRIMARY KEY (`id_total`)
							)',	
							'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'decidir_transacciones'.'`(
							...
							'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'decidir_tokens'.'`(
									`id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
									`user_id` VARCHAR(2) NULL DEFAULT NULL,
	...
	$insert_data = array('INSERT INTO `'._DB_PREFIX_.'interes` (installment, payment_method, coeficient, active) VALUES(2,"1",1.0589,0)',
						...
						'INSERT INTO `'._DB_PREFIX_.'promociones` (name, payment_method, entity, send_installment, days, init_date, final_date, installment, coeficient, discount, reimbursement, active) VALUES ("promo Visa 1", 1, 2, "", 30, "2016-11-01", "2018-12-31", 74, 1, 10, 15, 1)',
						...
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("'.utf8_encode("Tarjeta Más").'","Tarjeta",43,0)',
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("Tarjeta Carrefour / Cetelem","Tarjeta",44,0)',
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("'.utf8_encode("Tarjeta Club Día").'","Tarjeta",56,1)',
						...
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("PAGOMISCUENTAS (No disponible)","Cupon",41,0)',
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("PAGOFACIL (No disponible)","Cupon",25,0)',
						'INSERT INTO `'._DB_PREFIX_.'medios` (name, type, id_decidir, active) VALUES("RAPIPAGO (No disponible)","Cupon",26,0)',
						'INSERT INTO `'._DB_PREFIX_.'entidades` (name, active) VALUES("BANCO DE GALICIA Y BUENOS AIRES S.A.",1)',
						'INSERT INTO `'._DB_PREFIX_.'entidades` (name, active) VALUES("'.utf8_encode("BANCO DE LA NACIÓN ARGENTINA").'",1)',
						...
						'INSERT INTO `'._DB_PREFIX_.'entidades` (name, active) VALUES("'.utf8_encode("BBVA BANCO FRANCÉS S.A.").'",1)',
