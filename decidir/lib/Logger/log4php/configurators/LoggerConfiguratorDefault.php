...
class LoggerConfiguratorDefault implements LoggerConfigurator
{
	 ...
	 * Configures a logger. 
	 * 
	 * @param DecLogger $logger The logger to configure
	 * @param array $config DecLogger configuration options.
	 */
	private function configureLogger(DecLogger $logger, $config) {
