 ...
 * DecLogger can have. From log4j website:
 * 
...
class LoggerHierarchy {
	...
	/** Array holding all DecLogger instances. */
	 ...
	 * 
	 * @param string $name DecLogger name
	 * @return DecLogger Logger instance.
	 */
	public function getLogger($name) {
		if(!isset($this->loggers[$name])) {
			$logger = new DecLogger($name);
	...
	/**
	 * Prints the current DecLogger hierarchy tree. Useful for debugging.
	 */
