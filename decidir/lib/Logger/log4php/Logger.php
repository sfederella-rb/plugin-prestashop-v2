...
class DecLogger {
	...
	/**
	 * DecLogger additivity. If set to true then child loggers will inherit
	...
	/** The assigned DecLogger level. */
	private $level;
	
	/** The name of this DecLogger instance. */
	private $name;
	...
	/**
	 * Check whether this DecLogger is enabled for a given Level passed as parameter.
	 *
	...
	/**
	 * Check whether this DecLogger is enabled for the TRACE Level.
	 * @return boolean
	 */
	...
	/**
	 * Check whether this DecLogger is enabled for the DEBUG Level.
	 * @return boolean
	 */
	...
	/**
	 * Check whether this DecLogger is enabled for the INFO Level.
	 * @return boolean
	 */
	...
	/**
	 * Check whether this DecLogger is enabled for the WARN Level.
	 * @return boolean
	 */
	...
	/**
	 * Check whether this DecLogger is enabled for the ERROR Level.
	 * @return boolean
	 */
	...
	/**
	 * Check whether this DecLogger is enabled for the FATAL Level.
	 * @return boolean
	 */
	...
	/**
	 * Starting from this Logger, search the DecLogger hierarchy for a non-null level and return it.
	 * @see LoggerLevel
	...
	/**
	 * Get the assigned DecLogger level.
	 ...
	 * @param DecLogger $logger
	 */
	public function setParent(DecLogger $logger) {
		$this->parent = $logger;
	} 
	...
	/**
	 * Returns a DecLogger by name. If it does not exist, it will be created.
	 *
	...
	/**
	 * Clears all DecLogger definitions from the logger hierarchy.
	 * @return boolean
	 */
	...
	/**
	 * Returns an array this whole DecLogger instances.
	 * @see Logger
	 * @return array
	 */
