...
class DecControlFraudeService extends DecControlFraude {
    ...
    protected function completeCSVertical() {
        ...
        $datosCS["service_type"]		    = "0";
        $datosCS["dispatch_method"]			= "";
        $datosCS["reference_payment_service1"]	= "reference1";
        $datosCS["reference_payment_service2"]  = "reference2";
        $datosCS["reference_payment_service3"]	= "reference3";
